        ...
        <div class="footer-top">
            <div class="container">
                <div class="row gx-60 gy-4 text-center text-lg-start justify-content-between align-items-center">
                    <!-- <div class="col-lg vps"><a href="index.php"><img src="assets/img/vps.png" alt="logo"></a></div> -->
                    ...
                    <div class="col-lg-auto"><a href="registration.php" class="vs-btn">Enrol Now</a></div>
                </div>
            </div>
        </div>
                            ...
                            <div class="widget-about">
                                ...
                                <div class="sidebar-gallery">
                                    <div class="gallery-thumb">
                                        ...
                                        <a href="assets/img/widget/sciencelab.jpg" class="popup-image gal-btn"><i
                                                class="fal fa-plus"></i></a>
                                    </div>
                                    <div class="gallery-thumb">
                                        <img src="assets/img/widget/teacher.jpg" alt="Gallery Image" class="w-100">
                                        <a href="assets/img/widget/teacher.jpg" class="popup-image gal-btn"><i
                                                class="fal fa-plus"></i></a>
                                    </div>
                                    <div class="gallery-thumb">
                                        <img src="assets/img/widget/classgroup.jpg" alt="Gallery Image" class="w-100">
                                        <a href="assets/img/widget/classgroup.jpg" class="popup-image gal-btn"><i
                                                class="fal fa-plus"></i></a>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="copyright-wrap">
            <div class="container">
                <div class="row flex-row-reverse gy-3 justify-content-between align-items-center">
                    ...
                    <div class="col-lg-auto">
                        <p class="copyright-text ">Copyright &copy; 2024 All Rights
                        Reserved By <a href="index.php">visishtaschools</a> | Designed & Developed By Sriyan Solutions</p>
                    </div>
                </div>
            </div>
        </div>
