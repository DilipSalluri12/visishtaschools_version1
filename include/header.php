...
<body>
    ...
    ==============================-->
    <div class="preloader  ">
        <button class="vs-btn preloaderCls">visishtaschools Loading...</button>
    ...
    <div class="vs-menu-wrapper">
        <div class="vs-menu-area text-center">
            ...
            <div class="mobile-logo">
                <a href="index.php"><img src="assets/img/vps.png" alt="Visishta"></a>
            </div>
            <div class="vs-mobile-menu">
                <ul>
                   ...
                   <li>
                    ...
                    <li>
                        <a href="registration.php">Enrol Now</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="sidemenu-content">
            ...
            <div class="widget  ">
                <div class="widget-about">
                    <div class="footer-logo"><img src="assets/img/vps.png" alt="Visishta"></div>
            ...
            <div class="container">
                <div class="row justify-content-between align-items-center">
                    <div class="col-auto d-none d-lg-block">
                        ...
                        <ul>
                                <li>Welcome to Visishta Public School & Day Care</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="row gx-3 align-items-center justify-content-between">
                        <div class="col-8 col-sm-auto">
                            <div class="header-logo">
                                <a href="index.php">
                                    <img src="assets/img/vps.png" alt="logo">
                                </a>
                            </div>
                        </div>
                        <div class="col text-end text-lg-center">
                            <nav class="main-menu menu-style1 d-none d-lg-block">
                                <ul>
                                    ...
                                    <li>
                                        <a href="registration.php" class="regi">Enrol Now</a>
                                    </li>
                                </ul>
                            </nav>
